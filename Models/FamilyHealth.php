        ...
        try {
            ...
            $sqlCommand = $conn->prepare(
                "INSERT INTO familyhealthdetails(
                    axienty,
                    depression, domestic_violence,
                    criminal_behaviour, schizophrenia,
                    ...
                    describe_faith, feel_about, strengths, weaknesses, living_situation, accomplishment, client_name, client_id
